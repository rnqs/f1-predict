...
MODEL_PATH = "pitstop_model_v1.pkl"
...
def simular_estrategia(estrategia, incluir_pit=True):
    ...
    X = df[["compound", "stint_lap", "stint_number", "track", "race_lap", "team"]]
    ...
    if incluir_pit and n_stints > 1:
        total_pit_time = (n_stints - 1) * pit_loss

    df["tempo_acumulado"] = df["lap_time"].cumsum() + total_pit_time
...
if __name__ == "__main__":
    ...
    print(ranking[["nome", "tempo_voltas", "tempo_pit", "tempo_total"]])

    print("\nExemplo de voltas da melhor estratégia:")
    melhor_nome = ranking.iloc[0]["nome"]
    print(detalhes[melhor_nome].head(15))
